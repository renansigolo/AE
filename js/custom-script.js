jQuery(function ($) {
	...
	$(".navigation .mobile-nav-menu #burger-menu").on("click", function () {
	...
	$(".home-info-slider .info-slider-navigation .info-slider-navigation-list li").on("click", function () {
	...
	$(".page-handbook-container .handbook-container .handbook-collapse-container .handbook-list .container-title ").on("click", function () {
	...
	$(".page-blog-container .blog-container .search-popular .popular-posts .popular-post-list .wpp-list li .wpp-meta .wpp-date").each(function () {
	...
	$(".page-adv-diploma-container .ad-container .diploma-studies .listing-studies .studies-list .study-title p").on("click", function () {
	...
	$(".testimonial-navigation #tm-left").on( 'click', function () {
	...
	$(".testimonial-navigation #tm-right").on( 'click', function () {
		testimony.eq(testinow).hide("fast");
		testinow = testinow > 0 ? testinow - 1 : testimony.length - 1;
		testimony.eq(testinow).show("fast");
	});

	$(".r-post-diploma_navigation #tm-left").on( 'click', function () {
