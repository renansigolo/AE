...
<div class="single-page-bootcamp">
  ...
  <div class="col-12 offset-md-1 col-md-10 single-bootcamp-container">
    <div class="col-12 bootcamp-structure">
      <div class="row">
        <div class="col-12 bootcamp-structure-title" data-aos="fade-right">
          <h1><?php echo get_field('bootcamp_structure_title'); ?></h1>
        </div>
        <div class="col-12 col-md-5 bootcamp-structure-img" data-aos="fade-right">
          <img src="<?php echo get_field('bootcamp_structure_image'); ?>" alt="">
        </div>
        <div class="col-12 col-md-5 bootcamp-structure-info" data-aos="fade-left">
          <div class="sub-label">
    ...
    <div class="col-12 bootcamp-learn-how">
      <div class="row">
        <div class="col-12 bootcamp-learn-title" data-aos="fade-right">
        ...
        <div class="col-12 offset-md-1 col-md-10 bootcamp-learn-body">
          <div class="row">
            <div class="col-12 first-content">
              <div class="row">
                <div class="col-12 col-md-6 first-content-img" data-aos="fade-right">
                  <!-- <img src="<?php the_post_thumbnail_url(); ?>" alt=""> -->
                  <div class="embed-video-bootcamp">
                    <?php echo get_field('bootcamp_video'); ?>
                  </div>
                </div>
                <div class="col-12 col-md-6 first-content-text" data-aos="fade-left">
                  <p><?php echo get_field('learn_how_content'); ?></p>
                </div>
              </div>
            </div>
            <hr id="learn-how-line">
            <div class="col-12 offset-md-1 col-md-10 learn-how-second-header" data-aos="fade-up">
              <h3><?php echo get_field('learn_how_second_header'); ?></h3>
            </div>
            <div class="col-12 second-content">
              <div class="row">
                <div class="col-12 col-md-6 second-content-text" data-aos="fade-right">
                  <p><?php echo get_field('learn_how_second_content'); ?></p>
                </div>
                <div class="col-12 col-md-6 second-content-sched" data-aos="fade-left">
